The image is currently based on Fedora 32, so it is recommended to be built on Fedora 32 host. Current pre-built version is available at https://www.fi.muni.cz/~xzatovic/algtest-usb-disk.img
